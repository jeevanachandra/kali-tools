...
HOUDY ROOT# 
 ...
 00.Install All Kali-linux tools
	...
	if selection == 1:
		...
		cmd= os.system("apt install -y   armitage beef-xss nishang powersploit linux-exploit-suggester routersploit" )
		print ("\033[1;36m*********************************************************************************************1\033[1;m ")
		MainMenu()
